...
class FLClient(NumPyClient):
    def __init__(self, model: BaseNet, data_module: DataModule, params: DictConfig, logger: Logger, metrics_logger: MetricsLogger, callbacks: List[ClientCallback] = None):
